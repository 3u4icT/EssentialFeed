...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    private class HTTPSessionSpy: HTTPSession { // subclass to spy; but avoid using external classes for this it couples your tests with the implementation of other's code
